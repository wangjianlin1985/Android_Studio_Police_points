...
public class ZxySimpleAdapter extends SimpleAdapter { 
	/*需要绑定的控件资源id*/
    private int[] mTo;
    /*map集合关键字数组*/
...
/*需要绑定的数据*/
    ...
    public ZxySimpleAdapter(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to,ListView listView) { 
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  if (convertView == null) convertView = mInflater.inflate(R.layout.zxy_list_item, null);
	  convertView.setTag("listViewTAG" + position);
	  holder = new ViewHolder(); 
	  /*绑定该view各个控件*/
	  holder.tv_bname = (TextView)convertView.findViewById(R.id.tv_bname);
	  holder.tv_jid = (TextView)convertView.findViewById(R.id.tv_jid);
	  ...
	  holder.tv_jid.setText("积分条件：" + mData.get(position).get("jid").toString());
