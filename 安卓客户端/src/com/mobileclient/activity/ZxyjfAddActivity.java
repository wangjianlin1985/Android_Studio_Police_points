			...
			public void onClick(View v) {
				try {
					...
					if(ET_bid.getText().toString().equals("")) {
						Toast.makeText(ZxyjfAddActivity.this, "部门id输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_bname.getText().toString().equals("")) {
						Toast.makeText(ZxyjfAddActivity.this, "部门名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_btypes.getText().toString().equals("")) {
						Toast.makeText(ZxyjfAddActivity.this, "部门类型输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_sid.getText().toString().equals("")) {
						Toast.makeText(ZxyjfAddActivity.this, "警员id输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_sname.getText().toString().equals("")) {
						Toast.makeText(ZxyjfAddActivity.this, "警员姓名输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_jid.getText().toString().equals("")) {
						Toast.makeText(ZxyjfAddActivity.this, "积分条件ID输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_jftj.getText().toString().equals("")) {
						Toast.makeText(ZxyjfAddActivity.this, "积分条件输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_jfjd.getText().toString().equals("")) {
						Toast.makeText(ZxyjfAddActivity.this, "积分季度输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_fs.getText().toString().equals("")) {
						Toast.makeText(ZxyjfAddActivity.this, "分数输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_sl.getText().toString().equals("")) {
						Toast.makeText(ZxyjfAddActivity.this, "数量输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_xsfajf.getText().toString().equals("")) {
						Toast.makeText(ZxyjfAddActivity.this, "刑事发案积分输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_hmzfjf.getText().toString().equals("")) {
						Toast.makeText(ZxyjfAddActivity.this, "号码走访积分输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_cpfkjf.getText().toString().equals("")) {
						Toast.makeText(ZxyjfAddActivity.this, "测评反馈积分输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_dwzsjf.getText().toString().equals("")) {
						Toast.makeText(ZxyjfAddActivity.this, "单位重视积分输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传单位民警积分信息*/
					ZxyjfAddActivity.this.setTitle("正在上传单位民警积分信息，稍等...");
